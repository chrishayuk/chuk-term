...
class TestDemoCommand:
    ...
    def test_demo_full_flow(self):
        ...
        with patch('chuk_term.cli.ask', return_value="TestUser"):
            with patch('chuk_term.cli.confirm', side_effect=[True, False]):
                with patch('chuk_term.cli.select_from_list', return_value="monokai"):
    ...
    def test_demo_skip_themes(self):
        ...
        with patch('chuk_term.cli.ask', return_value="TestUser"):
            with patch('chuk_term.cli.confirm', return_value=False):
                result = runner.invoke(cli, ['demo'])
...
class TestMainFunction:
    ...
    def test_main_with_exception(self):
        ...
        with patch('chuk_term.cli.cli', side_effect=Exception("Test error")):
            with patch('chuk_term.cli.output.error') as mock_error:
                result = main()
                assert result == 1
    ...
    def test_main_with_keyboard_interrupt(self):
        ...
        with patch('chuk_term.cli.cli', side_effect=ValueError("Simulated error")):
            with patch('chuk_term.cli.output.error') as mock_error:
                result = main()
                assert result == 1
...
class TestEdgeCases:
    ...
    def test_cli_context_passing(self):
        ...
        with patch('chuk_term.cli.click.Context') as mock_context:
